...
public class FlavorPaletteListWrapper extends PaletteListWrapper {
     ...
     * <p/>
     * It adapts {@link Palette} into {@link ctc.kopo.pchu.R.layout#row_palette}
     */
    ...
    private static class PaletteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public PaletteHolder(View view, PaletteListWrapperListener listener) {
            ...
            mListener = listener;
            mPaletteRoundedThumbnail = (PaletteView) view.findViewById(ctc.kopo.pchu.R.id.row_color_palette_thumbnail);
            mPaletteName = (TextView) view.findViewById(ctc.kopo.pchu.R.id.row_color_palette_name);
